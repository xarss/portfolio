/**
 * FONTE DE DADOS DO PORTFÓLIO
 * Edite apenas este arquivo para atualizar projetos, keywords e CNPJ.
 */
const PORTFOLIO_DATA = {
  ...
  projects: [
    ...
    {
      title: "Rifa no Pix",
      url: "https://rifanopix.online",
      stack: ["Next.js", "React", "Pix", "Supabase"],
      done: ["Landing page", "SEO", "Blog", "Autenticação", "Automatização de pagamentos"],
      description: "Sistema completo de rifas online com pagamento via Pix, geração automática de bilhetes numerados e painel de sorteio em tempo real.",
